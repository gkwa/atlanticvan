...
import (
	...
	"github.com/gkwa/atlanticvan/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.atlanticvan.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".atlanticvan")
	}
